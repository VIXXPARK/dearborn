# Generated by Django 3.0.8 on 2020-11-04 14:17

import dearbornapp.models.contest
import dearbornapp.models.post
import dearbornapp.models.user
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(db_index=True, default=dearbornapp.models.user.User.make_uuid, editable=False, max_length=36, primary_key=True, serialize=False, unique=True)),
                ('nickname', models.CharField(max_length=50, unique=True)),
                ('profileImage', models.ImageField(blank=True, default=None, null=True, upload_to=dearbornapp.models.user.profileUploadTo)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(null=True, upload_to=dearbornapp.models.post.postUpload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dearbornapp.Post')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('image', models.ImageField(upload_to=dearbornapp.models.post.postImageUpload_to)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dearbornapp.Post')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=dearbornapp.models.contest.contestUpload_to)),
                ('banner', models.ImageField(null=True, upload_to=dearbornapp.models.contest.bannerUpload_to)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
